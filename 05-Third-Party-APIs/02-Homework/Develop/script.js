...
// Sets time block1/row 1 at 9am 
var beforeTime = moment().startOf('day').add(9, "hours");

//Increase each row +1 hour after 9am/and sets 9am
// 9 AM 
...
// Function to indicate current past/future/present using the CSS colors
// Adds the CSS classes to each form/input for 
function testTime() {
    // Add time1 9AM
